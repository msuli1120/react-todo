      ...
      <div>
        ...
        <form className="form-horizontal" onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="col-sm-10">
              <textarea name="todoDescription" className="form-control" rows="3" id="todoDescription" value={this.state.todoDescription} onChange={this.handleInputChange}></textarea>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-sm-10">
              <select name="todoPriority" id="todoPriority" className="form-control" value={this.state.todoPriority} onChange={this.handleInputChange}>
